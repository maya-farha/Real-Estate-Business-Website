    ...
    <div className="amCardBorder">
      ...
      <div className="amInformation ">
        <div className="amInfo ">
          <img
            src="https://maya-farha.github.io/Real-Estate-Business-Website/assets/icons/bedroom-Icon.svg"
            alt="bedroom-icon"
          />
        ...
        <div className="amInfo">
          <img
            src="https://maya-farha.github.io/Real-Estate-Business-Website/assets/icons/bathroom-Icon.svg"
            alt="bathroom-icon"
          />
          <span className="msFontSize18 msFontWeight500 msWhiteColor">
            {bathroom}-Bathroom
        ...
        <div className="amInfo">
          <img
            src="https://maya-farha.github.io/Real-Estate-Business-Website/assets/icons/villa.svg"
            alt="villa-icon"
          />
          <span className="msFontSize18 msFontWeight500 msWhiteColor">
            {type}
